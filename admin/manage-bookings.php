...
if (strlen($_SESSION['alogin']) == 0) {
	...
	# Cancel booking by updating tblbooking.Status to '2'
	...
	#Confirm booking by updating tblbooking.Status to '1'
								...
								<div class="panel-body">
									...
									<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
										...
										<tbody>
											...
											<?php 
											$sql = "SELECT tblusers.FullName,tblbrands.BrandName,tbllaptops.SerialNumber,tbllaptops.LaptopTitle,
											        tblbooking.FromDate,tblbooking.ToDate,tblbooking.TotalPrice,tblbooking.PaymentMode,tblbooking.PayStatus,
													tblbooking.LaptopId as vid,tblbooking.Status,tblbooking.PostingDate,tblbooking.id  from tblbooking
													join tbllaptops on tbllaptops.id=tblbooking.LaptopId 
													join tblusers on tblusers.EmailId=tblbooking.userEmail 
													join tblbrands on tbllaptops.LaptopBrand=tblbrands.id ";
											$query = $dbh->prepare($sql);
											$query->execute();
											...
											<tr>
												...
												<td><a href="editlaptop.php?id=<?php echo htmlentities($result->vid); ?>"><?php echo htmlentities($result->BrandName); ?> , <?php echo htmlentities($result->LaptopTitle); ?></td>
