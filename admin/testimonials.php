...
if (strlen($_SESSION['alogin']) == 0) {
	...
	# Deactivate testimonial from visibility in index page by updating tbltestimoial.status to '0'
    ...
    # Activate testimonial to be visibile in index page by updating tbltestimoial.status to '1'
