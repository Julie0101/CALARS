          ...
          <div class="container">
            <div class="user_profile_info gray-bg padding_4x4_40">
              ...
              <div class="upload_user_logo"><img src="assets/images/<?php echo htmlentities($result ->ProfilePhoto);?>" alt="image">
                <a href="changeprofile.php?imgid=<?php echo htmlentities($result->id) ?> ">Change Profile Photo</a>
              </div>
              ...
              <div class="dealer_info">
                ...
                <p>ID Number:<?php echo htmlentities($result->IdNumber); ?><br>
                <p>Admission Number:<?php echo htmlentities($result->AdmNo); ?><br>
                <p>Adress:<?php echo htmlentities($result->Address); ?><br>
